        ...
        return (
            <div>
                <div className="part1">
                    ...
                    <p>I believe in curiosity and energy, being driven by results, and being hard-working, with good communication and presentation skills, and problem-solving skills, analysis skills.</p>
                    <p>
                    ...
                    <p>                        I can create web applications using Python preferably but I can work with JavaScript as well, I am a team player, and I am open to learning and can adapt very quickly.
                    </p>
                </div>
                ...
                <div className="part 2">
                    ...
                    <p>  One of the reasons is what the company is doing for businesses interms of branding in every digital angles having my name in their books would be a great boost for my motivation to always strive for the best in my career and my CV.</p>

                    <p>                        This is a chance for me to add on what I have so that I could become a successful web developer in the near future with great industry exposure as a junior, that I am aspirng to be a senior web developer, adding value and insights is one of my strenghts, I believe in the power of AI, entrepreneurship and marketing.</p>
                    <p>
